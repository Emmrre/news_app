...
class TopHeadlinesGB extends StatefulWidget {
  const TopHeadlinesGB({super.key});

  @override
  State<TopHeadlinesGB> createState() => _TopHeadlinesGBState();
}

class _TopHeadlinesGBState extends State<TopHeadlinesGB> {
  @override
  void initState() {
    _newsMainViewModel.getNewsByCountryGB(countryName: 'gb');
  ...
  Widget build(BuildContext context) => Observer(
        builder: ((context) => ResultStateWidget<NewsMainModel?>(
            resultState: _newsMainViewModel.newsResultStateGb,
