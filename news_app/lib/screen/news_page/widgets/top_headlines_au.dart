...
class TopHeadlinesAu extends StatefulWidget {
  const TopHeadlinesAu({super.key});

  @override
  State<TopHeadlinesAu> createState() => _TopHeadlinesAuState();
}

class _TopHeadlinesAuState extends State<TopHeadlinesAu> {
  @override
  void initState() {
    _newsMainViewModel.getNewsByCountryAu(countryName: 'au');
  ...
  Widget build(BuildContext context) => Observer(
        builder: ((context) => ResultStateWidget<NewsMainModel?>(
            resultState: _newsMainViewModel.newsResultStateAu,
